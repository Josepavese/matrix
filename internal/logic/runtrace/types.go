...
type Run struct {
	...
	ModelFallbackUsed   bool                   `json:"model_fallback_used,omitempty"`
...
type Event struct {
	...
	SidecarProvider              string                 `json:"sidecar_provider,omitempty"`
	...
	SidecarCarrier               string                 `json:"sidecar_carrier,omitempty"`
	SidecarVisibility            string                 `json:"sidecar_visibility,omitempty"`
	ToolCallID                   string                 `json:"tool_call_id,omitempty"`
	ToolName                     string                 `json:"tool_name,omitempty"`
	ToolKind                     string                 `json:"tool_kind,omitempty"`
	ToolSemanticKind             string                 `json:"tool_semantic_kind,omitempty"`
	ToolEffect                   string                 `json:"tool_effect,omitempty"`
	ToolSubjectKind              string                 `json:"tool_subject_kind,omitempty"`
	ToolClassificationSource     string                 `json:"tool_classification_source,omitempty"`
	ToolClassificationConfidence string                 `json:"tool_classification_confidence,omitempty"`
